...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BcQGSvkY.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-DEeZrwVt.mjs").then((n) => n.t),
		import("./start-HgmKQqZ7.mjs"),
...
//#endregion
export { __exportAll as i, createCsrfMiddleware as n, createMiddleware as r, server_exports as t };
