...
export function GraphicDesignPromo({ onClose }: { onClose: () => void }) {
        ...
        <div className="p-4 space-y-4">
          <ul className="grid grid-cols-2 gap-x-2 gap-y-2.5 text-[11px] font-semibold text-foreground/80">
            <li className="flex items-center gap-1.5">
              <CheckCircle2 className="size-3.5 text-green-500" /> Thumbnails
            </li>
            <li className="flex items-center gap-1.5">
              <CheckCircle2 className="size-3.5 text-green-500" /> Banners
            </li>
            <li className="flex items-center gap-1.5">
              <CheckCircle2 className="size-3.5 text-green-500" /> Social Posts
            </li>
            <li className="flex items-center gap-1.5">
              <CheckCircle2 className="size-3.5 text-green-500" /> Logos & More
            </li>
          </ul>
          ...
          <div className="rounded-xl bg-gradient-to-b from-green-50 to-green-100/50 dark:from-green-950/30 dark:to-green-900/10 p-3 text-center border border-green-200/50 dark:border-green-800/30">
            <p className="text-[13px] font-bold mb-2 text-foreground">
          ...
          <div className="flex justify-center gap-3 text-[9px] font-medium text-muted-foreground uppercase tracking-wider">
            <div className="flex items-center gap-1">
              <Zap className="size-3 text-orange-400" /> Fast
            </div>
            <div className="flex items-center gap-1">
              <ShieldCheck className="size-3 text-green-500" /> Quality
            </div>
            <div className="flex items-center gap-1">
              <Infinity className="size-3 text-blue-400" /> Revisions
            </div>
          </div>

          <Button
            variant="outline"
            className="w-full text-xs h-9 rounded-xl font-semibold text-muted-foreground"
            onClick={onClose}
          >
            Not interested, skip
          </Button>
